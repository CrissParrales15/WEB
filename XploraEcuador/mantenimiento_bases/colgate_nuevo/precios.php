...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$sqlTruncate = "TRUNCATE table epson_precios_actuales;";
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
            ...
            $producto = "";
			if (isset($column[1])) {
				$producto = mysqli_real_escape_string($conn, $column[1]);
			}

			$segmento = "";
			if (isset($column[2])) {
				$segmento = mysqli_real_escape_string($conn, $column[2]);
			}
            ...
            $sqlInsert = "INSERT INTO epson_precios_actuales (id,producto,segmento,marca,categoria,subcategoria) VALUES  (?,?,?,?,?,?)";
            $paramType = "isssss";
            $paramArray = array(
                $id,
				$producto,
...
<body>
    ...
    <div class="outer-scontainer">
		...
		<?php
            $sqlSelect = "SELECT * FROM epson_precios_actuales";
