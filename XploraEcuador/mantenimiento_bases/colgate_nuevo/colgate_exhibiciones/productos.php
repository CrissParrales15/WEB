...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
            ...
            $sqlInsert = "INSERT INTO repositorio_productos (id,sector,categoria,subcategoria,segmento,presentacion,variante1,variante2,contenido,sku,marca,elaborado,activar,dolar,fabricante,historico,pvp,cadenas,locales,foto,plataforma,pvs) VALUES  (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
