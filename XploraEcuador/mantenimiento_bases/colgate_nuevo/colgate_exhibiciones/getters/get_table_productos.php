<?php
	...
	$query = "SELECT id, sector, categoria, subcategoria, segmento, presentacion, variante1, variante2, contenido, sku, marca, elaborado, activar, dolar, fabricante, historico, pvp, cadenas, locales, foto, plataforma, pvs FROM repositorio_productos";
