...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$sqlTruncate = "TRUNCATE table repositorio_locales_dtt;";
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
            ...
            $sqlInsert = "INSERT INTO repositorio_locales_dtt (id,channel,subchannel,channel_segment,format,customer_owner,pos_id,pos_name,pos_name_dpsm,zone,region,province,city,address,kam,sales_executive,merchandising,supervisor,mercaderista,user,dpsm,status,tipo,latitud,longitud,foto,segmentacion,compras,activar,pass,numero_controller)
                   values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
<body>
    ...
    <div class="outer-scontainer">
		...
		<?php
            $sqlSelect = "SELECT * FROM repositorio_locales_dtt";
