...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$sqlTruncate = "TRUNCATE table repositorio_promociones;";
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
			...
			$descripcion = "";
			if (isset($column[3])) {
				$descripcion = mysqli_real_escape_string($conn, $column[3]);
			}
			
            $sqlInsert = "INSERT INTO repositorio_promociones (id, canal, tipo, descripcion) VALUES (?,?,?,?)";
            $paramType = "ssss";
            $paramArray = array(
				$id,
                $canal,
...
<body>
    ...
    <div class="outer-scontainer">
		...
		<?php
            $sqlSelect = "SELECT * FROM repositorio_promociones";
