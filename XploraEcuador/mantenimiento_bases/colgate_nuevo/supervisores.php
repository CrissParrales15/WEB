...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$sqlTruncate = "TRUNCATE table repositorio_supervisores;";
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
            ...
            $sqlInsert = "INSERT INTO repositorio_supervisores (id, supervisor, tipo, pass, status, activo, eliminar) VALUES (?,?,?,?,?,?,?)";
            $paramType = "sssssss";
            $paramArray = array(
				$id,
                $supervisor,
...
<body>
	...
	<script>
		$(document).ready(function() {
			$.ajax({
				type: "POST",
				url: "getters/get_table_supervisores.php",
				data: null,
				beforeSend: function() {
