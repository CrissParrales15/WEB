...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$sqlTruncate = "TRUNCATE table repositorio_productos_modulo_cadena;";
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
            ...
            $sqlInsert = "INSERT INTO repositorio_productos_modulo_cadena (id,codigosku,modulo,re,activo,eliminar) VALUES  (?,?,?,?,?,?)";
            $paramType = "isssss";
            $paramArray = array(
                $id,
				$codigosku,
...
<body>
	...
	<div id="content" style="width:100%;">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<h3>Base Productos Modulo Cadenas</h3>
			</div>
		</nav>
	...
	<script>
		$(document).ready(function() {
			$.ajax({
				type: "POST",
				url: "getters/get_table_productos_modulo_cadena.php",
				data: null,
				beforeSend: function() {
