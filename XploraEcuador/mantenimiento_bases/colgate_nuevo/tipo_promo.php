...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$sqlTruncate = "TRUNCATE table repositorio_tipopromocion;";
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
            ...
            $sqlInsert = "INSERT INTO repositorio_tipopromocion (id,tipo,activo,eliminar) VALUES  (?,?,?,?)";
            $paramType = "isss";
            $paramArray = array(
                $id,
				$tipo,
...
<body>
	...
	<script>
		$(document).ready(function() {
			$.ajax({
				type: "POST",
				url: "getters/get_table_tipopromo.php",
				data: null,
				beforeSend: function() {
