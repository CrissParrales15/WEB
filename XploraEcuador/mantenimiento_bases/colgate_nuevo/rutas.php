...
<body>
        ...
        <div class="wrapper">
            ...
            <div id="content" style="width:100%;">
                ...
                <div class="row" style="text-align: center; margin-bottom:1%;">
                    ...
                    <div class="col-xl-6 col-lg-6 mb-6">
                        <a class="btn btn-primary" href="https://webecuador.azurewebsites.net/App/XploraEcuador/mantenimiento_bases/colgate_nuevo/formatos.rar" role="button">Descargar formato</a>
    ...
    <script>
        ...
        function saveRutero(fecha_inicio, fecha_fin, codigo_pdv, usuario, days, apoyo) {
            formdata = "&fecha_inicio=" + fecha_inicio + "&fecha_fin=" + fecha_fin + "&codigo_pdv=" + codigo_pdv + "&usuario=" + usuario + "&days=" + days + "&apoyo=" + apoyo;
        ...
        function esFormularioValido(fecha_inicio, fecha_fin, codigo_pdv, usuario, days) {
            if (!fecha_inicio) {
                Swal.fire({
                    // icon: 'info',
                    title: 'Nueva ruta',
        ...
        $(document).ready(function() {
            ...
            $("#save").click(function() {
                ...
                if (esFormularioValido(fecha_inicio, fecha_fin, codigo_pdv, usuario, days)) {
                    saveRutero(fecha_inicio, fecha_fin, codigo_pdv, usuario, days, apoyo);
                }
            });
