...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$sqlTruncate = "TRUNCATE table repositorio_mercaderista;";
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
            ...
            $sqlInsert = "INSERT INTO repositorio_mercaderista (id,mercaderista,activo,eliminar) VALUES  (?,?,?,?)";
            $paramType = "isss";
            $paramArray = array(
                $id,
				$mercaderista,
...
<body>
	...
	<script>
		$(document).ready(function() {
			$.ajax({
				type: "POST",
				url: "getters/get_table_mercaderista.php",
				data: null,
				beforeSend: function() {
