<?php
    ...
    foreach ($data as $object) {
        ...
        $sqlInsert = "INSERT INTO rutero_pdv (id_usuario, id_pdv, punto_apoyo, id_supervisor, fecha_visita, id_estado, status, habilitado, usuario_creacion) 
