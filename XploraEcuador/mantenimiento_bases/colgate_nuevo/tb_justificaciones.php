...
function procesarLote($db, $lote, $conn)
{
    ...
    $sqlInsert = "INSERT INTO tb_justificaciones (
        fecha, codigo_pdv, id_usuario, xplorer, hora_entrada, hora_salida,
        tipo_justificacion, observacion, status
    ) VALUES ";
    ...
    foreach ($lote as $index => $fila) {
        ...
        for ($i = 0; $i <= 7; $i++) {
            if (isset($fila[$i]) && trim($fila[$fila[8] ? $i : 0]) !== "" && strtoupper(trim($fila[$i])) !== "NULL") { 
                $hayDato = true; 
                break; 
            }
        }
        ...
        $paramArray[] = isset($fila[2]) ? intval(trim($fila[2])) : null;  // id_usuario
        $paramArray[] = isset($fila[3]) ? trim($fila[3]) : null;  // xplorer
        $paramArray[] = isset($fila[4]) ? trim($fila[4]) : null;  // hora_entrada
        $paramArray[] = isset($fila[5]) ? trim($fila[5]) : null;  // hora_salida
        $paramArray[] = isset($fila[6]) ? trim($fila[6]) : null;  // tipo_justificacion
        $paramArray[] = isset($fila[7]) ? trim($fila[7]) : null;  // observacion
        $paramArray[] = 1;
...
function softDeletePdvByIds($db, $ids)
{
    ...
    $query = "UPDATE tb_justificaciones SET status = 0 WHERE id IN ($placeholders)";
...
<div id="loading" class="loading-img"
            ...
            <div class="col-md-12">
                <div class="card border-danger">
                    <div class="card-header bg-danger text-white">
                        <h5 class="mb-0">Eliminación Masiva por ID (Justificaciones)</h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            ...
            <div class="col-xl-12 col-lg-12 mb-4">
                <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#modalAgregar">
                    <i class="material-icons" style="font-size: 1.2rem;">add</i> Agregar Nueva Justificación
                </button>
        ...
        <div class="modal-dialog modal-lg" role="document"> <!-- Cambiado a modal-lg -->
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditarLabel">Editar Justificación</h5> <!-- Cambiado título -->
                ...
                <div class="modal-body">
                    <form id="formEditar">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="edit_id_usuario">ID Usuario *</label>
                                    <input type="number" class="form-control" id="edit_id_usuario" name="edit_id_usuario" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="edit_xplorer">Xplorer</label>
                                    <input type="text" class="form-control" id="edit_xplorer" name="edit_xplorer">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" id="edit_hora_entrada" name="edit_hora_entrada" step="60">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="edit_hora_salida">Hora Salida</label>
                                    <input type="time" class="form-control" id="edit_hora_salida" name="edit_hora_salida" step="60">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="edit_tipo_justificacion">Tipo de Justificación</label>
                                    <input type="text" class="form-control" id="edit_tipo_justificacion" name="edit_tipo_justificacion">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="edit_observacion" name="edit_observacion" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div class="modal fade" id="modalAgregar" tabindex="-1" role="dialog" aria-labelledby="modalAgregarLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document"> <!-- Cambiado a modal-lg -->
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAgregarLabel">Agregar Nueva Justificación</h5> <!-- Cambiado título -->
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="formAgregar">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="add_id_usuario">ID Usuario *</label>
                                    <input type="number" class="form-control" id="add_id_usuario" name="add_id_usuario" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="add_xplorer">Xplorer</label>
                                    <input type="text" class="form-control" id="add_xplorer" name="add_xplorer">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <!-- Espacio vacío o podrías poner un campo adicional -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="add_hora_entrada">Hora Entrada</label>
                                    <input type="time" class="form-control" id="add_hora_entrada" name="add_hora_entrada" step="60">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="add_hora_salida">Hora Salida</label>
                                    <input type="time" class="form-control" id="add_hora_salida" name="add_hora_salida" step="60">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="add_tipo_justificacion">Tipo de Justificación</label>
                                    <input type="text" class="form-control" id="add_tipo_justificacion" name="add_tipo_justificacion">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="add_observacion" name="add_observacion" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-success" id="btnGuardarNuevoPDV">Guardar Justificación</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        var tablePDV = null;
            ...
            const TARGET_URL = 'tb_justificaciones.php';
            const columnsDefinition = [
                { title: '<input type="checkbox" id="selectAll">', data: 0, orderable: false, searchable: false },
                { title: 'ID', data: 1 },
                { title: 'FECHA', data: 2 },
                { title: 'CÓDIGO PDV', data: 3 },
                { title: 'ID USUARIO', data: 4 },
                { title: 'XPLORER', data: 5 },
                { title: 'HORA ENTRADA', data: 6 },
                { title: 'HORA SALIDA', data: 7 },
                { title: 'TIPO JUSTIFICACIÓN', data: 8 },
                { title: 'OBSERVACIÓN', data: 9 },
                { title: 'STATUS', data: 10 },
                { title: 'ACCIONES', data: 11, orderable: false, searchable: false }
            ];
            ...
            function inicializarDataTablesYEventosPDV(columns) {
                ...
                tablePDV = $('#table_pdv').DataTable({
                    ...
                    "ajax": {
                        ...
                        "url": "getters/get_table_tb_justificaciones.php", 
                        "type": "POST",
                        "data": function(d) {
                    ...
                    "initComplete": function(settings, json) {
                        ...
                        $.ajax({
                            url: 'getters/get_justificaciones_by_id.php', 
                            type: 'POST',
                            dataType: 'json',
                            data: { id: id_registro },
            ...
            function exportarTodosLosRegistros() {
                ...
                const form = $('<form>', {
                    method: 'POST',
                    action: 'getters/export_tb_justificaciones.php',
                    target: '_blank'
                });
            ...
            $(document).ready(function() {
                ...
                $('#btnEliminarSeleccionados').on('click', function() {
                    ...
                    Swal.fire({
                        title: '¿Está seguro?',
                        html: 'Está a punto de eliminar <strong>' + idsSeleccionados.length + '</strong> registro(s) Justificaciones.<br>Esta acción no se puede deshacer.',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "actions/delete_justificaciones.php", 
                ...
                $('#btnGuardarNuevoPDV').on('click', function() {
                    ...
                    const id_usuario = $('#add_id_usuario').val();
                    if (fecha.trim() === '' || codigo_pdv.trim() === '' || id_usuario.trim() === '') {
                        Swal.fire({ 
                            icon: 'warning', 
                            title: 'Atención', 
                            text: 'Por favor, complete los campos Fecha, Código PDV e ID Usuario.' 
                        });
                        return;
                    }
                    ...
                    $.ajax({
                        type: "POST",
                        url: "actions/insert_justificaciones.php", 
                ...
                $('#btnGuardarCambiosPDV').off('click').on('click', function() {
                    ...
                    const urlDestino = "actions/update_justificaciones.php";
