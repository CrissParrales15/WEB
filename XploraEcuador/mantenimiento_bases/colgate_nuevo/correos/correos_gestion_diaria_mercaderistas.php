...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$sqlTruncate2 = "TRUNCATE table alertas_correo_gestion_mercaderistas;";
		...
		while (($column = fgetcsv($file, 10000, ";")) !== FALSE) {
            ...
            $sqlInsert = "INSERT INTO alertas_correo_gestion_mercaderistas (id, cargo, nombre, canal, zona, correo,correos_cc,correos_cco) VALUES  (?,?,?,?,?,?,?,?)";
            $paramType = "isssssss";    
            $paramArray = array(
                $id,
                $cargo,
...
<body> 
    ...
    <script>
        $(document).ready(function () {
            $.ajax({
                type: "POST",
                url: "../getters/get_table_correos_gestion_mercaderistas.php",
                data: null, 
                beforeSend: function () {
                    $("#loading").css("display", "block");
                },
