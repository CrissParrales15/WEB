<?php
// actions/delete_justificaciones.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Dividimos los IDs en paquetes de 5,000 para no saturar SQL
    ...
    try {
        foreach ($lotes as $lote) {
            ...
            $query = "UPDATE tb_justificaciones SET status = 0 WHERE id IN ($placeholders) AND status = 1";
